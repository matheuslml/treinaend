...
var FullCalendar = function(e) {
    ...
    function pr(e, t) {
        ...
        return r(i, (n = e, o = t.dateEnv, r(r({}, ur(n.range, o, n.allDay)), {
            allDay: n.allDay
        }))), i
    }
    ...
    var br = function() {
        ...
        Cr = function() {
            ...
            return e.prototype.setProp = function(e, t) {
                ...
                else if ("id" === e) t = _n[e](t), this.mutate({
                    standardProps: {
                        publicId: t
                    }
                });
    ...
    var Ir = function() {
        ...
        Nr = {
            ...
            weekText: "W",
            allDayText: "toda-semana",
            moreLinkText: "mais",
            noEventsText: "Sem RAS"
        };

    function Hr(e) {
        for (var t = e.length > 0 ? e[0].code : "en", n = Pr.concat(e), r = {
                en: Nr
    ...
    var Ei = [Ho({
        ...
        propSetHandlers: {
            dateProfile: function(e, t) {
                t.emitter.trigger("datesSet", r(r({}, lr(e.activeRange, t.dateEnv)), {
                    view: t.viewApi
                }))
            },
    ...
    var Ri = function() {
        function e(e) {
            ...
            var s, l, u, c = (s = o.calendarOptions, l = o.dateEnv, null != (u = s.initialDate) ? l.createMarker(u) : Dr(s.now, l)),
        ...
        return e.prototype.resetOptions = function(e, t) {
            ...
            var e, t, n, o, i, a, s, l, u, c = this.props,
                ...
                y = f.calendarOptions;
            if (m && m !== y)
                for (var E in m.timeZone !== y.timeZone && (d.eventSources = v.eventSources = (a = v.eventSources, s = d.dateProfile, l = v, u = s ? s.activeRange : null, ri(a, ii(a, l), u, !0, l)), d.eventStore = v.eventStore = (e = v.eventStore, t = p.dateEnv, n = v.dateEnv, o = e.defs, i = gt(e.instances, (function(e) {
                        var i = o[e.defId];
    ...
    function Da(e, t, n) {
        return !!zn(t.validRange, e.range) && ba({
            dateSelection: e
        }, n)
    }
    ...
    function Aa(e, t) {
        for (var n = [], r = 0, i = e; r < i.length; r++)
            for (var a = i[r], s = a.span || 1, l = 0; l < s; l += 1) n.push(mo("col", {
                style: {
        ...
        gs = function() {
            function e(e) {
                ...
                this.subjectEl = null, this.selector = "", this.handleSelector = "", this.shouldIgnoreMove = !1, this.shouldWatchScroll = !0, this.isDragging = !1, this.isTouchDragging = !1, this.wasTouchScroll = !1, this.handleMouseDown = function(e) {
                    ...
                    passive: !0
                }), 1 === (hs += 1) && window.addEventListener("touchmove", ms, {
                    passive: !1
                })
            }
            return e.prototype.destroy = function() {
                this.containerEl.removeEventListener("mousedown", this.handleMouseDown), this.containerEl.removeEventListener("touchstart", this.handleTouchStart, {
                    passive: !0
                }), (hs -= 1) || window.removeEventListener("touchmove", ms, {
                    passive: !1
                })
    ...
    var Ps = function(e) {
        function t(t) {
            ...
            n.draggingSegEl = null, n.draggingSeg = null, n.eventRange = null, n.relevantEvents = null, n.validMutation = null, n.mutatedRelevantEvents = null, n.handlePointerDown = function(e) {
                ...
                }), c ? He() : Oe(), t || (l && Ts(a, e) && (l = null), n.validMutation = l, n.mutatedRelevantEvents = u)
            }, n.handleDragEnd = function(e) {
                var t = n.component.context,
                    o = n.eventRange.def,
        ...
        for (var p = s.addSegs(l), f = function(e, t, n) {
                for (var r = function(e, t) {
                    ...
                    for (var g = 0, m = l; g < m.length; g++) {
                        ...
                        var y, E = y.spanEnd - y.spanStart > 1,
                            S = y.spanStart === s;
    ...
    var ml = function(e) {
        ...
        El = function(e) {
            function t() {
                var t = null !== e && e.apply(this, arguments) || this;
                return t.allDaySplitter = new fl, t.headerElRef = Eo(), t.rootElRef = Eo(), t.scrollerElRef = Eo(), t.state = {
                    slatCoords: null
                ...
                return f.push({
                    ...
                    chunks: [{
                        ...
                        content: function(e) {
                            ...
                            }, e.tableColGroupNode, mo("tbody", null, mo(ml, {
                                slatMetas: i
                            }))), mo("div", {
                ...
                var t = e.entriesByLevel,
                    n = Pl((function(e, t) {
                        ...
                        var a = xl(function(e, t, n) {
                                ...
                                for (; l < s; l += 1) {
                                    for (var u = o[l], c = void 0, d = Bi(u, i.spanStart, Wi), p = d[0] + d[1], f = p;
            ...
            return n(t, e), t.prototype.render = function() {
                ...
                var i = this.buildSegInputs(e).map((function(i) {
                    ...
                    return mo("div", {
                        ...
                        seg: a
                    }, nr(a, o.todayRange, o.nowDate))) : Qa(t))
                }));
                return mo(So, null, i)
    ...
    var Wl = function(e) {
        function t() {
            var t = null !== e && e.apply(this, arguments) || this;
            return t.processSlotOptions = Ft(Vl), t.state = {
                slatCoords: null
    ...
    }, e.triggerDateSelect = dr, e.unmountComponentAtNode = wo, e.unpromisify = lo, e.version = "5.7.2", e.whenTransitionDone = Ie, e.wholeDivideDurations = Ht, Object.defineProperty(e, "__esModule", {
        value: !0
    }), e
}({});