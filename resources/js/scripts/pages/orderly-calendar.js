...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function eventClick(info) {
        ...
        eventToUpdate.extendedProps.vacancy !== undefined ? eventVacancy.val(eventToUpdate.extendedProps.vacancy) : null;
        ...
        eventToUpdate.extendedProps.description !== undefined ? eventDescription.val(eventToUpdate.extendedProps.description) : null;
    ...
    function updateEvent(eventData) {
        window.location.replace('/ras/' + eventData['id']);
    }
    ...
    updateEventBtn.on('click', function() {
        if (eventForm.valid()) {
            var eventData = {
                ...
                extendedProps: {
                    location: eventLocation.val(),
                    vacancy: sidebar.find(eventVacancy).val(),
                    guests: eventGuests.val(),
                    calendar: eventLabel.val(),
                    description: eventDescription.val()
                },
