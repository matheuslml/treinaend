                            ...
                            <div class="row mb-4">
                                ...
                                <div  style="position: relative;">
                                    <div style="width:100%; height: 100%; text-align: center;">
                                        ...
                                        style="object-fit: cover;border:solid 1px;border-color: #b9d9ba !important;">
                                    </div>
                                </div>
                                <!-- Imagem FIM -->
                                    ...
                                    <a href="{{ route('news_web_show', $new->id) }}">
                                        <div class="d-flex flex-row">
                                            ...
                                            <div class="col-md-7 ps-2 ">
                                                <div>
                                                    <h3 style="font-size: 14px; font-weight: 600" class="two-line-truncate">
                                                        {{$new->title}}
                                                    </h3>
                                                </div>
                                                <div>
                                                    <h3 style="font-size: 14px; font-weight: 150" class="text-muted two-line-truncate">
                                                        {{$new->description}}
                                                    </h3>
                                                </div>
                                            </div>
