        ...
        <div class="card-body ">
          ...
          <div class="col-lg-12 align-items-center auth-bg px-2 p-lg-5">
            ...
            @include('flash::message')
              ...
              @endif
              <form class="auth-register-form mt-2" action="{{ route('licitacoes.store') }}" method="POST" >
                @csrf()
                  <div class="content-header mb-2">
                      <h2 class="fw-bolder mb-75">Dados da  Nova Licitação</h2>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-4 mb-1">
                      <label class="form-label" for="bidding">Licitação<strong>*</strong></label>
                      <input type="text" name="bidding" id="bidding" class="form-control" placeholder="1234/2022" />
                    </div>
                    <div class="col-md-4 mb-1">
                    ...
                    <div class="col-md-4 mb-1">
                      <label class="form-label" for="realized_at">Data da licitação<strong>*</strong></label>
