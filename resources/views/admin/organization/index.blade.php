    ...
    <div class="col-md-4 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Cadastrar Nova Organização</h4>
        </div>
        <div class="card-body">
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('organizacoes.store') }}">
            @csrf()
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <select class="select2 form-select" id="active" name="active" required>
              ...
              @foreach($organizations as $organization)
                ...
                @endif
                    ...
                    <td style="display: none;">
                      <a href="{{ route('organizacoes.show', $organization->id) }}" title="Editar" class="btn btn-info btn-sm" style="color: white; "><i data-feather="edit" class="font-small-4"></i></a>
                    </td>
                  </tr>
              @endforeach
            </tbody>
