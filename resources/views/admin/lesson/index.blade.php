    ...
    <div class="col-md-4 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Cadastrar Nova Aula</h4>
        </div>
        <div class="card-body">
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('aulas.store') }}" enctype="multipart/form-data">
            @csrf()
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="link_video">Link do Youtube<tag data-bs-toggle="tooltip" title="Nome do Aula"><i data-feather='info'></i></tag></label>
                  </div>
                  <div class="col-sm-9">
    ...
    <div class="col-md-8 col-12">
      <div class="card">
        <div class="card-header border-bottom">
          <h4 class="card-title">Aulas Cadastradas - Busca Avançada</h4>
        </div>
        <hr class="my-0" />
            ...
            <tbody>
              ...
              @foreach($lessons as $lesson)
                ...
                @endif
                    ...
                    <td style="display: none;">{{ isset($lesson->discipline->name) ? $lesson->discipline->name : '' }}</td>
                    <td style="display: none;">{{ $lesson->order }}</td>
                    <td style="display: none;">{{isset($lesson->created_at) ? (($lesson->created_at)->format('d/m/Y H:m:s')) : ''}}</td>
                    <td style="display: none;">
                      <a href="{{ route('aulas.show', $lesson->id) }}" title="Editar" class="btn btn-info btn-sm" style="color: white; "><i data-feather="edit" class="font-small-4"></i></a>
                    </td>
                  </tr>
              @endforeach
            </tbody>
...
@section('page-script')
  {{-- Page js files --}}
  <script src="{{ asset(mix('js/scripts/tables/lessons.js')) }}"></script>
