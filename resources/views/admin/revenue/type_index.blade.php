    ...
    <div class="col-md-4 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Cadastrar Novo Tipo de Receita</h4>
        </div>
        <div class="card-body">
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('receita_tipos.store') }}">
            @csrf()
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="title" class="form-control" name="title" placeholder="Nome do Tipo de Receita" required />
                  </div>
                </div>
              </div>
        ...
        @if (count($revenue_types) >= 1)
          ...
          @else
            <div class="alert alert-warning" role="alert">
              ...
              <div class="alert-body">
                Não existem Tipos de Receita Armazenadas.
              </div>
            </div>
          @endif
        </div>
