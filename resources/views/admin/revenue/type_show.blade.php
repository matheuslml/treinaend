    ...
    <div class="col-md-4 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Dados do Tipo de Receita</h4>
        </div>
        <div class="card-body">
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('receita_tipos.update', $type_selected->id) }}">
            @csrf()
            @method('PUT')
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" value="{{ $type_selected->title }}" id="title" class="form-control" name="title" placeholder="Nome do Receita" />
                  </div>
                </div>
              </div>
              <div class="col-sm-9 offset-sm-3">
                ...
                <form method="POST" name="form-delete" action="{{ route('receita_tipos.destroy', $type_selected->id) }}">
                    @csrf()
                    @method('delete')
        ...
        @if (count($revenue_types) >= 1)
              ...
              @foreach($revenue_types as $type)
                ...
                @endif
                    ...
                    <td style="display: none;">
                      <a href="{{ route('receita_tipos.show', $type->id) }}" title="Editar" class="btn btn-info btn-sm" style="color: white; "><i data-feather="edit" class="font-small-4"></i></a>
                    </td>
                  </tr>
              @endforeach
            </tbody>
          ...
          @else
            <div class="alert alert-warning" role="alert">
              ...
              <div class="alert-body">
                Não existem Tipos de Receitas Armazenadas.
              </div>
            </div>
          @endif
        </div>
