                        ...
                        <div class="row col col-10 index-table" style="margin-top: 6%;">
                            ...
                            @if (count($revenues) >= 1)
                                ...
                                <thead>
                                    ...
                                    <th>Referente</th>
                                    <th>Recolhimento</th>
                                    <th>Início da Arrecadação</th>
                                    <th>Fim da Arrecadação</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    @foreach($revenues as $revenue)
                                        <tr>
                                            ...
                                            <td>{{ $revenue->value }}</td>
                                            <td>{{ $revenue->type->title }}</td>
                                            <td>{{ $revenue->referent }}</td>
                                            <td>{{ date('d-m-Y', strtotime($revenue->receipt_at)) }}</td>
                                            <td>{{ date('d-m-Y', strtotime($revenue->collection_initial_at)) }}</td>
                                            <td>{{ date('d-m-Y', strtotime($revenue->collection_final_at)) }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                </table>
