    ...
    <div class="col-md-6 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Gerar Relatório de Despesas</h4>
          <p>selecione as datas, para gerar um relatório com todos as despesas deste período selecionado.</p>
        </div>
        <div class="card-body">
        @include('flash::message')
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('report_expenses_pdf') }}">
            @csrf()
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                ...
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="title">Tipos de Despesas</label>
                  </div>
                  <div class="col-sm-9">
                    <select class=" form-select" id="type_expense" name="type_expense" required>
