...
<html dir="ltr" lang="en-US">
    ...
    <body style="display: block;">
                    ...
                    <div class="info-data">
                        ...
                        <div class="row col col-10 index-table" style="margin-top: 6%;">
                                ...
                                <tbody>
                                    @foreach($expenses as $expense)
                                        <tr>
                                            ...
                                            <td>{{ $expense->typeExpense->title }}</td>
                                            <td>
                                                <input type="text" class="form-control current-balance"  
                                                    value="{{ str_replace('.',',', $expense->current_balance) }}"
                                                />
                                            </td>
                                            <td>{{ $expense->blocked_balance }}</td>
                                            <td>{{ $expense->used_balance }}</td>
                                            <td>{{ $expense->available_balance }}</td>
                            ...
                            @else
                                ...
                                <i class="fas fa-times"></i> Não existem RAS Armazenados.
                                </div>
                            @endif
                            </div>
                        </div>
        ...
        <script src="vendors/js/forms/cleave/addons/cleave-phone.br.js"></script>
        <script src="js/scripts/forms/expense-report-mask.js"></script>
    </body>
</html>