...
@section('title', 'Tipos de Requisições')
    ...
    <div class="col-md-4 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Cadastrar Novo Tipo de Requisição</h4>
        </div>
        <div class="card-body">
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('ouvidoria_requisicoes.store') }}">
            @csrf()
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
