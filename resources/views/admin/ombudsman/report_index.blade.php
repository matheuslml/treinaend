    ...
    <div class="col-lg-3 col-sm-6">
      <div class="card">
        <div class="card-body d-flex align-items-center justify-content-between">
          <div>
            <h3 class="fw-bolder mb-75">{{ count($ombudsman) }}</h3>
    ...
    <div class="col-md-6 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Gerar Relatório de Manifestações</h4>
          <p>selecione as datas, para gerar um relatório com todos os RAS deste período selecionado.</p>
        </div>
        <div class="card-body">
        @include('flash::message')
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('report_ombudsman_pdf') }}">
            @csrf()
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="title">Tipo de Relatório</label>
                  </div>
                  <div class="col-sm-9">
