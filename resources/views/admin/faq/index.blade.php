    ...
    <div class="col-md-4 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Cadastrar Nova FAQ</h4>
        </div>
        <div class="card-body">
          ...
          @endif
          <form class="form form-horizontal" method="post" action="{{ route('faqs.store') }}" >
            @csrf()
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="question">Pergunta<strong>*</strong></label>
                  </div>
                  <div class="col-sm-9">
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="answer">Resposta<strong>*</strong></label>
                  </div>
                  <div class="col-sm-9">
