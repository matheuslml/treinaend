          ...
          <form class="form form-horizontal" method="POST" action="{{ route('ocupacoes.update', $occupation_selected->id) }}">
            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="title">Ocupação<strong>*</strong><tag data-bs-toggle="tooltip" title="nome do cargo EX: Auxiliar Administrativo"><i data-feather='info'></i></tag></label>
                  </div>
                  <div class="col-sm-9">
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="departament_id">Departamento<strong>*</strong></label>
                  </div>
                  <div class="col-sm-9">
