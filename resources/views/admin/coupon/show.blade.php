            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                      <input type="text" class="form-control" id="title" name="title" value="{{ $coupon_selected->title }}" />
                  </div>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                      <input type="text" class="form-control" id="code" name="code" value="{{ $coupon_selected->code }}" />
                  </div>
                </div>
              </div>
              <div class="col-12">
                      ...
                      <select class="select2 form-select" id="course_id" name="course_id">
                        <optgroup label="Selecione">
                            @foreach ($courses as $course)
                                <option value="{{  $course->id }}" {{ $coupon_selected->course_id == $course->id ? 'selected' : '' }}>{{  $course->name }}</option>
                            @endforeach
                        </optgroup>
                      </select>
                  </div>
              ...
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                      <input type="text" class="form-control" id="observation" name="observation" value="{{ $coupon_selected->observation }}" />
                  </div>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-lg">
                        <input type="number" class="touchspin" value="{{ $coupon_selected->amount }}"  id="amount" name="amount" />
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-lg">
                        <input type="number" class="touchspin" value="{{ $coupon_selected->discount_percentage }}"  id="discount_percentage" name="discount_percentage" />
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-lg">
                        ...
                        value="{{ $coupon_selected->started_at }}"/>
                    </div>
                  </div>
                </div>
              </div>
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <div class="input-group input-group-lg">
                        <input type="text" id="finished_at" name="finished_at" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD" value="{{ $coupon_selected->finished_at }}"/>
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                      <select class="select2 form-select" id="status" name="status">
                        <optgroup label="Selecione">
                            <option value="PUBLISHED" {{ $coupon_selected->status == 'PUBLISHED' ? 'selected' : '' }}>Publicado</option>
                            <option value="DRAFT" {{ $coupon_selected->status == 'DRAFT' ? 'selected' : '' }}>Editando</option>
                            <option value="BLOCKED" {{ $coupon_selected->status == 'BLOCKED' ? 'selected' : '' }}>Bloqueado</option>
                        </optgroup>
                      </select>
                  </div>
                </div>
