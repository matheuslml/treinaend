    ...
    <div class="col-md-4 col-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('noticia_categorias.store') }}">
            @csrf()
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="title" class="form-control" name="title" placeholder="Nome da Categoria" required />
                  </div>
                </div>
                <div class="mb-1 row">
                  <div class="col-sm-3">
