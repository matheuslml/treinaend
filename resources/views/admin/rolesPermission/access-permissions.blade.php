      ...
      <div class="row">
        ...
        <div class="col-sm-7">
          <div class="card-body text-sm-end text-center ps-sm-0">
            ...
            >
              <span class="btn btn-primary mb-1">Nova Permissão</span>
            </a>
            ...
            <tbody>
              ...
              @foreach($permissions as $permission)
                ...
                @endif
                    ...
                    <td style="display: none;">{{ isset($permission->name) ? $permission->name : '' }}</td>
                    <td style="display: none;">{{ isset($permission->information->description) ? $permission->information->description : '' }}</td>
