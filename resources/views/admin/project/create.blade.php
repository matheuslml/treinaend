        ...
        <div class="card-body ">
          ...
          <div class="col-lg-12 align-items-center auth-bg px-2 p-lg-5">
            ...
            @include('flash::message')
              ...
              @endif
              <form class="auth-register-form mt-2" action="{{ route('projetos.store') }}" method="POST" enctype="multipart/form-data">
                @csrf()
                  <div class="content-header mb-2">
                      <h2 class="fw-bolder mb-75">Cadastrar Novo Programa</h2>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-12 mb-1">
                      <label class="form-label" for="sub_title">Sub título<strong>*</strong></label>
                    ...
                    <div class="col-md-6 mb-1">
                      ...
                      <select class="form-select" id="responsible_id" name="responsible_id" >
                        ...
                        @foreach($responsibles as $responsible)
                          <option value="{{ $responsible->id }}"  >{{ $responsible->title }}</option>
                        @endforeach
                      </select>
                    </div>
                    ...
                    <div class="col-md-12 mb-1">
                      <label class="form-label">PDF do Projeto</label>
