    ...
    <div class="col-md-5 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Cadastrar Novo Progresso</h4>
        </div>
        <div class="card-body">
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('projeto_progressos.store') }}">
            @csrf()
            <div class="">
              <div class=" row">
                <div class="col-md-6 mb-1">
                    <label class="form-label" for="percentage">Porcentagem<strong>*</strong></label>
                    <input type="integer" name="percentage" id="percentage" class="form-control" required />
                  </div>
                  <div class="col-md-6 mb-1">
