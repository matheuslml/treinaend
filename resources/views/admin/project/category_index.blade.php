    ...
    <div class="col-md-4 col-12">
      <div class="card">
        ...
        <div class="card-body">
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('projeto_categorias.store') }}">
            @csrf()
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
              ...
              @foreach($categories as $category)
                ...
                @endif
                    ...
                    <td style="display: none;">
                      <a href="{{ route('projeto_categorias.show', $category->id) }}" title="Editar" class="btn btn-info btn-sm" style="color: white; "><i data-feather="edit" class="font-small-4"></i></a>
                    </td>
                  </tr>
              @endforeach
            </tbody>
