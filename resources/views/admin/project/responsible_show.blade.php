    ...
    <div class="col-md-4 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Dados da Unidade Responsável</h4>
        </div>
        <div class="card-body">
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('projeto_responsaveis.update', $responsible_selected->id) }}">
            @csrf()
            @method('PUT')
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" value="{{ $responsible_selected->title }}" id="title" class="form-control" name="title" placeholder="Nome do Receita" />
                  </div>
                </div>
                <div class="mb-1 row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9">
                    <input type="text" value="{{ $responsible_selected->description }}" id="description" class="form-control" name="description" placeholder="Nome do Receita" />
                  </div>
                </div>
              </div>
              <div class="col-sm-9 offset-sm-3">
                ...
                <form method="POST" name="form-delete" action="{{ route('projeto_responsaveis.destroy', $responsible_selected->id) }}">
                    @csrf()
                    @method('delete')
