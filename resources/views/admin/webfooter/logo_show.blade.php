    ...
    <div class="col-md-4 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Logo do Rodapé</h4>
        </div>
        <div class="card-body">
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('webfooter_logos.update', $web_footer_logo_selected->id ) }}" enctype="multipart/form-data" >
            @csrf()
            @method('PUT')
            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-1 row">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="title" value="{{ $web_footer_logo_selected->title }}" class="form-control" name="title" placeholder="Título da Logo" />
                  </div>
                </div>
                <div class="mb-1 row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9">
                    <input type="text" id="link_url" value="{{ $web_footer_logo_selected->link_url }}" class="form-control" name="link_url" />
                  </div>
                </div>
                <div class="mb-1 row">
                  <div class="col-sm-3">
                  ...
                  <div class="col-sm-9">
                    <select class="form-select" id="status" name="status" >
                      ...
                      <option value="DRAFT" {{ $web_footer_logo_selected->status == 'DRAFT' ? 'selected' : '' }} >Desenvolvendo</option>
                      <option value="PENDING" {{ $web_footer_logo_selected->status == 'PENDING' ? 'selected' : '' }}  >Pendente</option>
                      <option value="PUBLISHED" {{ $web_footer_logo_selected->status == 'PUBLISHED' ? 'selected' : '' }}  >Publicada</option>
                    </select>
                  </div>
                </div>
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="logo_old">Logo Antiga<strong>*</strong></label>
                  </div>
                  <div class="col-sm-9">
                    <img
                      class="img-fluid rounded mb-75"
                      src="{{asset('storage/images/webfooters/' . $web_footer_logo_selected->logo_url)}}"
                      alt="avatar img"
                    />
                  </div>
                </div>
                <div class="mb-1 row">
                  <div class="col-sm-3">
                    <label class="col-form-label" for="logo">Logo<strong>*</strong></label>
                  </div>
                  <div class="col-sm-9">
              ...
              <div class="col-sm-9 offset-sm-3">
                ...
                <form method="POST" name="form-delete" action="{{ route('webfooter_logos.destroy', $web_footer_logo_selected->id) }}">
                    @csrf()
                    @method('delete')
