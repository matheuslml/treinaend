        ...
        <div class="col-md-8 col-12">
            <div class="card ">
                ...
                <div class="col-lg-12 align-items-center auth-bg px-2 p-lg-5">
                    ...
                    @endif
                    <form class="auth-register-form mt-2" action="{{ route('webfooters.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf()
                        <div class="content-header mb-2">
                            <h2 class="fw-bolder mb-75">Cadastrar Nova WebFooter</h2>
                        </div>
                            ...
                            <div class="col-md-4 mb-1">
                                <label class="form-label" for="float_icon_url">Ícone Flutuante (80x100 px)<strong>*</strong></label>
                                <input type="file" id="float_icon_url" class="form-control" name="float_icon_url" />
                            </div>

                            <div class="col-md-12 mb-1" hidden>
                            <textarea  name="content_left" id="content_left" class="form-control" ></textarea>
                            </div>
                            ...
                            <div class="col-md-12 mb-1" hidden>
                            <textarea  name="content_right" id="content_right" class="form-control" ></textarea>
                            </div>
