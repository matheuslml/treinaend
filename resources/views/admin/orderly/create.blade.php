    ...
    <div class="col-md-4 col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">Cadastrar RAS</h4>
        </div>
        <div class="card-body">
        @include('flash::message')
          ...
          @endif
          <form class="form form-horizontal" method="POST" action="{{ route('ras.store') }}">
            @csrf()
              ...
              <div class="col-12">
                <div class="mb-1 row ">
                    ...
                    <div class="input-group" style="width: 50%;">
                        <input type="number" class="touchspin-min-max" id="vacancy" name="vacancy" value="0" />
                    </div>
                </div>
              </div>
              <div class="col-12">
                  ...
                  <div class="col-sm-9">
                    <select class="select2 form-select" id="time_id" name="time_id">
                      @foreach($times as $time)
                          <option value="{{ $time->id }}" >{{ $time->period }}</option>
                      @endforeach
                    </select>
                  </div>
                </div>
            ...
            <tbody>
              ...
              @foreach($orderlies as $orderly)
                ...
                @endif
                    ...
                    <td style="display: none;">
                      <a href="{{ route('ras.show', $orderly->id) }}" title="Editar" class="btn btn-info btn-sm" style="color: white; "><i data-feather="edit" class="font-small-4"></i></a>
                    </td>
                  </tr>
              @endforeach
            </tbody>
