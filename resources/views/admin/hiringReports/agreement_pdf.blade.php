                                ...
                                <tbody>
                                    @foreach($agreements as $agreement)
                                        <tr>
                                            ...
                                            <td>{{ isset($agreement->bidding->title) ? $agreement->bidding->title : '' }}</td>
                                            <td>{{ $agreement->process }}</td>
                                            <td>{{ $agreement->agreementOrigin->title }}</td>
                                            <td>{{ $agreement->agreementType->title }}</td>
                                            <td>{{ $agreement->agreementSituation->title }}</td>
                                            <td>{{ $agreement->value }}</td>
                                            <td>{{ date('d-m-Y', strtotime($agreement->date_signature)) }}</td>
                                            <td>{{ date('d-m-Y', strtotime($agreement->date_diary)) }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                </table>
