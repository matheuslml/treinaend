                                ...
                                <tbody>
                                    @foreach($biddings as $bidding)
                                        <tr>
                                            ...
                                            <td>{{ $bidding->modality->title }}</td>
                                            <td>{{ $bidding->situation->title }}</td>
                                            <td>
                                                @foreach($bidding->bidding_agreements as $agreement)
                                                {{ $agreement->process . '; ' }}
                                                @endforeach
                                            </td>
                                            <td>{{ $bidding->value_max }}</td>
                                            <td>{{ date('d-m-Y', strtotime($bidding->published_at)) }}</td>
                                            <td>{{ date('d-m-Y', strtotime($bidding->realized_at)) }}</td>
                                        </tr>
                                    @endforeach
                                </tbody>
                                </table>
