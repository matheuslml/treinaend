        ...
        <div class="card-body ">
          ...
          <div class="col-lg-12 align-items-center auth-bg px-2 p-lg-5">
            ...
            @include('flash::message')
              ...
              @endif
              <form class="auth-register-form mt-2" action="{{ route('info_sensiveis.update', $project->id) }}" method="POST" enctype="multipart/form-data">
                @csrf()
                @method('PUT')
                  <div class="content-header mb-2">
                      <h2 class="fw-bolder mb-75">Sigílo ID: {{$project->id}}</h2>
                  </div>
                  <div class="row">
                  <div class="col-md-12 mb-1">
                    ...
                    <div class="col-md-12 mb-1">
                      ...
                      <textarea name="description" maxlength="60" id="description" class="form-control" required >{{ $project->description }}</textarea>
                    </div>
                    ...
                    <div class="col-md-6 mb-1">
                      ...
                      <select class="form-select" id="responsible_id" name="responsible_id" >
                        <option value="{{ $project->responsible->id }}"  >{{ $project->responsible->name }}</option>
                        <hr>
                  ...
                  <div class="col-12 mt-2">
                    ...
                    <form method="POST" name="form-delete" action="{{ route('info_sensiveis.destroy', $project->id) }}">
                        @csrf()
                        @method('delete')
                    ...
                    <a href="{{asset('storage/files/sensitive_informations/' . $project->archive)}}" style="position: relative; float: right;margin-left:20px;" class="btn btn-flat-danger" download="{{$project->title}}_{{$project->archive}}">
                          Baixar Arquivo
                        </a>
                  </div>
            </div>
