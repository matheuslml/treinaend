      ...
      <ul class="nav navbar-nav">
        <li class="nav-item">
          <a class="navbar-brand" href="{{ url('/') }}">
            ...
            <h2 class="brand-text mb-0">TREINAEND</h2>
          </a>
        </li>
      </ul>
    </div>
  ...
  <div class="bookmark-wrapper d-flex align-items-center">
    ...
    <ul class="nav navbar-nav bookmark-icons">
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href=""
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Agenda"><i class="ficon"
            data-feather="calendar" hidden></i></a>
      </li>
      @role('Administrador')
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href=""
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Relatórios"><i class="ficon"
            data-feather="pie-chart"></i></a>
      </li>
      @endrole
      <li class="nav-item d-none d-lg-block"><a class="nav-link" href="{{ route('faq') }}"
          data-bs-toggle="tooltip" data-bs-placement="bottom" title="Ajuda"><i class="ficon"
  ...
  <ul class="nav navbar-nav align-items-center ms-auto">
    ...
    <li class="nav-item dropdown dropdown-notification me-25">
      <a class="nav-link" href="javascript:void(0);" data-bs-toggle="dropdown">
        ...
        <span class="badge rounded-pill bg-danger badge-up">{{ count(Auth::user()->notifications->where('status_id', 2)) }}</span>
      </a>
          ...
          @foreach(Auth::user()->notifications->where('status_id', 2) as $newNotification)
            <a class="d-flex" href="{{ route('notificacoes.show', $newNotification->id) }}">
              <div class="list-item d-flex align-items-start">
                <div class="me-1">
                  <div class="avatar">
                    <img src="{{ isset($newNotification->sender->profile_photo_path) ? asset($newNotification->sender->profile_photo_path) : asset('images/portrait/small/avatar-icon.png') }}" alt="avatar" width="32"
                      height="32">
                  </div>
                </div>
                <div class="list-item-body flex-grow-1">
                  <p class="media-heading"><span class="fw-bolder">{{ $newNotification->title }}</span></p>
                  <small class="notification-text"> {{ $newNotification->type->title }}</small>
                </div>
              </div>
            </a>
          @endforeach
