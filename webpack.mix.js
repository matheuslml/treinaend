...
// Reports Core stylesheets
mixAssetsDir('scss/base/reports/**/!(_)*.scss', (src, dest) =>
    mix.sass(src, dest.replace(/(\\|\/)scss(\\|\/)/, '$1css$2').replace(/\.scss$/, '.css'), { sassOptions })
)
...
mix
    ...
    .js('resources/assets-web/js/site/site.js', 'public/assets-web/js/site')
    .js('resources/assets-web/js/site/gallery.js', 'public/assets-web/js/site')
    .js('resources/assets-web/js/app.js', 'public/assets-web/js')
    .js('resources/assets-web/js/owl.carousel.js', 'public/assets-web/js')
    ...
    .sass('resources/assets-web/css/site.scss','public/assets-web/css', { sassOptions})
