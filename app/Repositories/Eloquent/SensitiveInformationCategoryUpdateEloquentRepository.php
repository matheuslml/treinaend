...
class SensitiveInformationCategoryUpdateEloquentRepository extends EloquentRepository
{
    #[Pure]
    ...
    public function create(array $data): SensitiveInformationCategory | Model
    {
    ...
    public function update($id, array $data): SensitiveInformationCategory | Model
    {
