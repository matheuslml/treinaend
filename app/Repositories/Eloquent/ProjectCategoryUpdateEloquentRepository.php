...
class ProjectCategoryUpdateEloquentRepository extends EloquentRepository
{
    //#[Pure]
    ...
    public function create(array $data): ProjectCategory | Model
    {
    ...
    public function update($id, array $data): ProjectCategory | Model
    {
