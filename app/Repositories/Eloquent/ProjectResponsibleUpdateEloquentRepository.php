...
class ProjectResponsibleUpdateEloquentRepository extends EloquentRepository
{
    //#[Pure]
    ...
    public function create(array $data): ProjectResponsible | Model
    {
    ...
    public function update($id, array $data): ProjectResponsible | Model
    {
