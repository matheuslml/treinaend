...
class NewsUpdateEloquentRepository extends EloquentRepository
{
    //#[Pure]
    ...
    public function create(array $data): News | Model
    {
    ...
    public function update($id, array $data): News | Model
    {
