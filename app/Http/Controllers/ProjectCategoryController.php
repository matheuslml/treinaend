...
$copyright = Copyright::where('status', 'PUBLISHED')->first();
            ...
            return view('admin.project.category_index', ['pageConfigs' => $pageConfigs], compact('categories', 'unit', 'copyright', 'courses_nav'));
    ...
    public function show($category_id)
    {
        ...
        try{
            ...
            $unit = Unit::where('web', true)->first();
$copyright = Copyright::where('status', 'PUBLISHED')->first();
            return view('admin.project.category_show', compact('category_selected', 'categories', 'unit', 'copyright', 'courses_nav'));
