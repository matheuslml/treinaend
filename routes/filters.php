...
//News
//Route::post('/web/news_filtered', 'App\Http\Controllers\WebController@blog_web_index_filter_title')->name('blog_web_index_filter_title');
//Route::get('/web/news_filtered_category/{category_id}', 'App\Http\Controllers\WebController@blog_web_index_filter_category')->name('blog_web_index_filter_category');
//Route::get('/web/news_filtered_tag/{tag_id}', 'App\Http\Controllers\WebController@blog_web_index_filter_tag')->name('blog_web_index_filter_tag');
